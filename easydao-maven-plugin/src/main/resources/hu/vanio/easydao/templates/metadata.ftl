...
#
# FIELDS
# The virtual fields are read-only.

${"TABLE.FIELD NAME"?right_pad(70)} ${"JAVA NAME"?right_pad(30)} ${"DB TYPE"?right_pad(30)} ${"JAVA TYPE"?right_pad(10)} ${"PK"?right_pad(5)} ${"VIRTUAL"?right_pad(8)} ${"NULLABLE"?right_pad(9)} ${"ARRAY"?right_pad(6)} COMMENT
<#list tList as t>
<#list t.fieldList as f>
${"${t.dbName}.${f.dbName}"?right_pad(70)} ${f.javaName?right_pad(30)} ${f.dbType?right_pad(30)} ${f.javaTypeAsString?right_pad(10)} ${"${f.primaryKey?c}"?right_pad(5)} ${"${f.virtual?c}"?right_pad(8)} ${"${f.nullable?c}"?right_pad(9)} ${"${f.array?c}"?right_pad(6)} ${f.comment}
</#list>
</#list>
